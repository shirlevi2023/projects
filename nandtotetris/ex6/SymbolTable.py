...
class SymbolTable:
    ...
    def add_entry(self, symbol: str, address: int) -> None:
        ...
        symbol=symbol.strip('\n')
        symbol=symbol.strip()
        self.symbol_dictionarie[symbol]=address
        pass
    ...
    def contains(self, symbol: str) -> bool:
        ...
        return symbol in self.symbol_dictionarie
        pass
    ...
    def get_address(self, symbol: str) -> int:
        ...
        symbol = symbol.strip('\n')
        symbol = symbol.strip()
        if symbol in self.symbol_dictionarie:
            return self.symbol_dictionarie[symbol]
        return symbol
        pass
